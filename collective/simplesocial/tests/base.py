...
def setup_product():
    ...
    import collective.simplesocial
    zcml.load_config('configure.zcml', collective.simplesocial)
    ...
    ztc.installPackage('collective.simplesocial')
...
setup_product()
ptc.setupPloneSite(products=['collective.simplesocial'])
